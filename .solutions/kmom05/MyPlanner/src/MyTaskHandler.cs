...
/// <summary>
/// This class MyTaskHandler takes care of the tasks in a planning tool.
/// </summary>
public class MyTaskHandler
{
    ...
    public bool UpdateTask(string location, string title, string description, DateTime dueDate, bool completed = false)
    {
        bool updateOk = false;
    ...
    public bool UpdateTask(int prio, int estimatedTime, int timeWorked, string projectName, string title, string description, DateTime dueDate, bool completed = false)
    {
        bool updateOk = false;
